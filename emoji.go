...
var DefaultPalettes = []Palette{
	...
	},
	{
		...
		Emojis: []string{
			...
			EmojiVictoryHand, EmojiThumbsUp, EmojiThumbsDown, EmojiClappingHands,
	...
	},
	{
		...
		Emojis: []string{
			...
			EmojiCloudWithRain, EmojiSnowflake, EmojiLightning, EmojiFire,
	...
	},
	{
		...
		Icon: EmojiGear,
		Emojis: []string{
			EmojiGear, EmojiWrench, EmojiHammer, EmojiShield,
	...
	},
	{
		...
		Emojis: []string{
			EmojiArrowUp, EmojiArrowDown, EmojiArrowLeft, EmojiArrowRight,
			EmojiArrowUpRight, EmojiArrowDownRight, EmojiArrowDownLeft, EmojiArrowUpLeft,
			EmojiLeftRightArrow, EmojiUpDownArrow, EmojiRefresh,
		},
	},
}
...
var EmojiTags = map[string][]string{
	...
	"⚠️": {"warning", "alert", "danger", "yellow", "caution"},
	"ℹ️": {"info", "information", "blue", "about"},
	"⚙️": {"gear", "settings", "cog", "tool", "config"},
	...
	"🛡️": {"shield", "defense", "protect", "security"},
